package com.commercialeater.config;

import com.commercialeater.persistance.entity.*;
    ...
    public static SessionFactory getSessionFactory() {
        ...
        if (sessionFactory == null) {
            try {
                ...
                settings.put(Environment.URL, "jdbc:mysql://localhost:55555/commercial_eater");
